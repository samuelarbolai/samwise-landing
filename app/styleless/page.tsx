export default function Home() {
  return (
    <main style={{ maxWidth: "700px", margin: "40px auto", padding: "0 20px", lineHeight: "1.6" }}>
      <nav
        style={{
          display: "flex",
      ...
      >
        <a href="/styleless/scientific-evidence" style={{ textDecoration: "underline" }}>
          Scientific Evidence →
        </a>
      </nav>
      ...
      <p>
        We are building a solution for this. A solution that remains with you at
        all times of your journey of getting rid of the disease of
