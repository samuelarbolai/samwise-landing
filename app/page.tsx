...
const copy = {
  en: {
    ...
    step1Body: "It will last 20 minutes. All the questions about the program will be answered here. The outcome will be whether we are a good fit for your needs or not.",
  ...
  es: {
    ...
    step1Body: "Durará 20 minutos. Todas las preguntas sobre el programa se responderán aquí. El resultado será determinar si somos un buen ajuste para tus necesidades o no.",
